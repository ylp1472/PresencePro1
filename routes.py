...
# Camera Setup (Simulating with a video file, change to 0 for local webcam)
video_capture = cv2.VideoCapture('path_to_video.mp4')  # Change this to your video file path for testing
